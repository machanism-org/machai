 ...
 * <p>
 * This class provides the foundational logic for starting and configuring an HTTP server
 * using Jetty, including thread pool management, port configuration, and servlet transport provider setup.
 * Subclasses should provide specific servlet implementations for handling MCP requests.
 * </p>
 *
...
public abstract class AbstractHttpMcpServer extends AbstractMcpServer {
     ...
     * <p>
     * Initializes the Jetty server, configures the thread pool, sets up the server connector,
     * and registers the provided servlet to handle all incoming requests.
     * </p>
     *
