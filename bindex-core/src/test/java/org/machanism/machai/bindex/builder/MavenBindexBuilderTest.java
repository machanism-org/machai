...
class MavenBindexBuilderTest {
    ...
    // More comprehensive tests should be implemented if core logic is extended with IO or additional dependencies.
    // Consider mocking GenAIProvider and file operations if required for full logic coverage.
}