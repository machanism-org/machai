...
/**
 * BindexCreator is responsible for generating and updating BIndex representation files
 * for the supplied project layout using a GenAIProvider.
 * <p>
 * Usage example:
 * <pre>
...
public class BindexCreator extends BIndexProjectProcessor {
    ...
    /** Flag specifying whether to invoke LLM for indexing. */
