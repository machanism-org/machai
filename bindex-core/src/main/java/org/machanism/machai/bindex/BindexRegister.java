 ...
 *
 * <p>This type reads {@code bindex.json} from a project directory and uses {@link Picker} to insert
 * or update the corresponding document in the registry.
 *
 * <h2>Example</h2>
 *
 * <pre>{@code
...
public class BindexRegister extends BindexProjectProcessor {
	 ...
	 * @throws IllegalArgumentException if {@code projectLayout} is {@code null} or registration fails
	 */
