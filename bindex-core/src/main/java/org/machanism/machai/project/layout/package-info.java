 ...
 *
 * <p>This package provides {@link org.machanism.machai.project.layout.ProjectLayout}, an abstraction for describing
 * where modules, sources, tests, and documentation live relative to a project root directory. Implementations
 * typically detect a layout by looking for a build or configuration file in a directory and then deriving module
 * boundaries and well-known root folders.
 *
