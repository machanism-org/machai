...
public abstract class ProjectProcessor {
     ...
     * If modules are present, each module is processed. Otherwise, the entire folder structure is processed.
     *
     ...
     * @param processor The {@link ProjectLayout} object representing the folder structure to process.
     */
    public abstract void processFolder(ProjectLayout processor);

    /**
     * Returns the detected {@link ProjectLayout} for the specified project directory.
