...
| [Ghostwriter-Py](https://github.com/machanism-org/ghostwriter-py/tree/ad04b1c0103287b22cbceaaffdabee9796bffa18) | Python wrapper around the Ghostwriter command-line processor. It embeds the Java runtime in Python and exposes Ghostwriter processing through the `machai.gw` package and `gw` function. |
