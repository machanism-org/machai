...
| [Ghostwriter-Py](https://github.com/machanism-org/ghostwriter-py/tree/2ee6b2ba1b84bcd252f9417098d0845adc4168b9) | Python wrapper around the Ghostwriter command-line processor. It embeds the Java runtime in Python and exposes Ghostwriter processing through the `machai.gw` package and `gw` function. |
