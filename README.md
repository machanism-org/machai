...
| [Ghostwriter-Py (mgw)](https://github.com/machanism-org/ghostwriter-py/tree/f923c57c4176fec024156f36b3afb9a06465cfe7) | Python wrapper around the Ghostwriter command-line processor. It embeds the Java runtime in Python and exposes Ghostwriter processing through the `mgw` package and `gw` function. |
