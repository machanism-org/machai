...
| [Ghostwriter-Py](https://github.com/machanism-org/ghostwriter-py/tree/0ed09967e8652687fb98b3e97cace41c8a4c9157) | Python wrapper around the Ghostwriter command-line processor. It embeds the Java runtime in Python and exposes Ghostwriter processing through the `machai.gw` package and `gw` function. |
