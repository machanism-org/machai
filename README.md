...
| [CLI](cli/) | CLI is the Machai command line application module. It provides a Spring Boot and Spring Shell based interactive shell for bindex and Ghostwriter workflows, including generating and updating `bindex.json`, registering metadata, performing semantic search, assembling projects from picks, running Ghostwriter guided tasks, and cleaning local workspace artifacts. |
