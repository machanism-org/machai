...
class CreateTest {
	...
	private static class TestCreate extends Create {
		boolean bindexed;
	...
	@Test
	void execute_whenNotBindexed_skipsCreateButFinallyRuns() throws Exception {
		// Arrange
		TestCreate mojo = new TestCreate();
	...
	@Test
	void execute_whenBindexed_callsCreateBindexWithUpdateFalse() throws Exception {
		// Arrange
		TestCreate mojo = new TestCreate();
		MavenProject project = new MavenProject(new Model());
		...
		org.junit.jupiter.api.Assertions.assertEquals(Boolean.FALSE, mojo.updateArg);
		org.junit.jupiter.api.Assertions.assertTrue(mojo.usageLogged);
	}
