...
| [Machai CLI](machai-cli/) | Command line tool to generate and update bindex.json, register metadata, pick libraries using semantic search, assemble projects from picked results, and run Ghostwriter workflows from the terminal. |
