...
| Name | Description |
| --- | --- |
| [Project Layout](project-layout/) | Project Layout is a small, focused Java API for detecting and describing a software project on-disk structure (main/test source roots, resource roots, and multi-module/workspace layouts). It provides a consistent way to infer a repository layout from the files present so tooling can avoid hard-coded conventions. It supports common ecosystems such as Maven, Node/JavaScript workspaces, and Python projects by modeling their layout conventions and exposing normalized source and resource roots plus child project detection. |
