...
| `gw.nonRecursive` | In Act definitions, disables recursive module traversal when `true`. | `false` unless an Act sets it; no direct Ghostwriter CLI option. |
| `gw.interactive` | In Act definitions, enables or disables interactive processing. | Processor/Act default unless an Act sets it; no direct Ghostwriter CLI option. |
