 ...
 * <p>
 * Extracts documented guidance from Markdown content using a special tag
 * for input into automated documentation workflows.
 */
public class MarkdownReviewer implements Reviewer {
    ...
    /**
     * Reviews the given Markdown file for contained guidance comments and formats the content
     * for input to documentation generators.
     *
