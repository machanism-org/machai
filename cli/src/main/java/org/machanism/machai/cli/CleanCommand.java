 ...
 * <p>
 * The {@code CleanCommand} class includes methods for removing all
...
public class CleanCommand {
     ...
     *
     * @param dir The path to the project directory. If null, uses the user directory.
    ...
    public void clean(
            @ShellOption(help = "The path fo the project directory.", defaultValue = ShellOption.NULL, value = "dir") File dir)
            throws IOException {
        if (dir == null) {
