...
/**
 * Maven goal {@code gw:std} for processing guided documents within a single
 * Maven module.
 *
 * <p>
 * By default, this goal processes the current module immediately. When executed
 * from the reactor root it can optionally delay processing of the
 * execution-root project until other reactor projects have completed.
 * </p>
 *
 * <h2>Parameters</h2>
 *
 * <p>
 * This goal defines the parameter below and also inherits the shared parameters
 * from {@link AbstractGWGoal}.
 * </p>
 *
 * <h3>Goal-specific parameters</h3>
 * <dl>
 * <dt>{@code gw.rootProjectLast} (user property: {@code -Dgw.rootProjectLast},
 * default: {@code false})</dt>
 * <dd>If {@code true}, delays processing of the execution-root project (the
 * project returned by {@code MavenSession#getExecutionRootDirectory()}) until
 * all other reactor projects have completed.</dd>
 * </dl>
 *
 * <h3>Shared parameters (inherited from {@link AbstractGWGoal})</h3>
 * <p>
 * This goal inherits additional parameters from {@link AbstractGWGoal}. See
 * that class for the complete list, including defaults and supported formats.
 * </p>
 *
 * <h2>Usage</h2>
 *
