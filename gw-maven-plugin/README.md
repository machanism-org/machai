...
GW Maven Plugin (Ghostwriter Maven Plugin) is a documentation automation Maven plugin for Maven-based Java projects. It scans your repository for embedded `@guidance:` directives and uses them to generate and update Maven Site documentation, helping keep docs consistent, current, and aligned with the in-repo source of truth.
