...
class TypeConverter {
	 ...
	 * <p>
	 * If the specified Java class is not mapped in the internal type map, the
	 * default type {@code "object"} is returned.
	 * </p>
	 *
	 * @param type the Java class to map; may be {@code null}
	 * @return the mapped simplified type name (e.g., {@code "string"},
	 *         {@code "integer"}, {@code "array"}), or {@code "object"} if the type
	 *         is unknown or {@code null}
	 */
	 ...
	 * {@link Map} (with specialized value types of {@link Integer}, {@link Double},
	 * or {@link String}), primitives, or objects with a constructor taking a single
	 * {@link String} argument. If direct constructor instantiation fails, it falls
	 * back to deserialization using Jackson's {@link ObjectMapper}.
	 * </p>
	 *
	 ...
	 * @return the converted object, or {@code null} if the input is null, or the
	...
	/**
	 * Maps a primitive Java {@link Class} type to its equivalent Object wrapper
	 * class representation.
	 * <p>
	 * For instance, maps {@code int.class} to {@code java.lang.Integer.class},
	 * {@code boolean.class} to {@code java.lang.Boolean.class}, etc. If the given
	 * type is not a recognized primitive name, the type is returned unchanged.
	 * </p>
	 *
	 * @param type the primitive Java class type to map
	 * @return the wrapped Object class equivalent representation, or the original
	 *         type if unmapped
	 */
