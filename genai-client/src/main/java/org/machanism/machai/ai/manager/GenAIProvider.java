 ...
 * <p>
 * Implementations of this interface must provide concrete logic for interacting with different AI models,
 * allowing prompt submission as text or files, managing internal resources, supporting file operations
 * (including remote files via URL), computing embeddings, and adding custom tool functions at runtime.
 * <p>
 * <b>Main Features:</b>
 * <ul>
 *   <li>Prompt support for both text and file-based input.</li>
 *   <li>Resource management for files and model-specific state.</li>
 *   <li>Extensibility through custom tool functions accepting <code>JsonNode</code> arguments.</li>
 *   <li>Ability to clear internal state and select model/instructions dynamically.</li>
