 ...
 *
 * <p>
 * The {@code ParamDescriptor} class encapsulates metadata about a parameter, including its name, type,
 * whether it is required, and a description of its purpose or usage.
 * </p>
 *
 * <ul>
 *   <li><b>name</b>: The parameter's name.</li>
 *   <li><b>type</b>: The parameter's data type (e.g., "String", "Integer", "JsonNode").</li>
 *   <li><b>required</b>: Indicates whether the parameter is mandatory.</li>
 *   <li><b>description</b>: A brief description of the parameter's purpose or usage.</li>
 * </ul>
 *
 * <p>
 * This class is typically used to document and validate parameters for tool functions, prompts, or other
 * callable entities within the framework.
 * </p>
 */
