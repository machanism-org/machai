 ...
 * <p>
 * This class supports dynamic loading of GenAIProvider classes using reflection and resolves providers 
 * based on the model name format (e.g. "OpenAI:gpt-3.5-turbo").
 * <p>
 * Usage example:
 * <pre>
