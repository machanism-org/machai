...
/**
 * The {@code NoneProvider} is a stub implementation of {@link GenAIProvider} used as a placeholder.
 * <p>
 * This class does not interact with any AI service or LLM. All operations are either no-ops or throw exceptions
 * where appropriate. Intended for environments where AI services are disabled, testing, or default fallback scenarios.
 * </p>
 * <b>Usage Example:</b>
 * <pre>
...
public class NoneProvider implements GenAIProvider {
     ...
     * No operation in this implementation.
     *
    ...
    /**
     * Writes the prompts and instructions (if present) to files if {@code inputsLog} is set. Always returns {@code null}.
     *
